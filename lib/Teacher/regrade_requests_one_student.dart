...
class RegradeRequestsOneStudent extends StatefulWidget {
  const RegradeRequestsOneStudent({Key? key}) : super(key: key);

  @override
  State<RegradeRequestsOneStudent> createState() => _RegradeRequestsOneStudentState();
}
...
class _RegradeRequestsOneStudentState extends State<RegradeRequestsOneStudent> {
